...
3.4基于计算机的交易对市场质量的影响有哪些
 ...
 “闪电式崩溃”之后市场上还发生了几起类似的流动性不足事件。例如，2011年6月8日天然气期货暴跌8.1%，几秒钟之后就反弹回去。2011年2月2日，一段出错的程序每秒钟在原油市场发出了2000到3000个订单，导致了波动的8倍激增。在这段程序关闭之前，原油价格上下波动幅度达到1美元。在三月份，在被确定为“胖手指问题”（在输入数据时出现问题这一现象的俗称）所导致的价格下跌98%之后，10个新的晨星交易所交易基金（ exchange traded funds, ETF）的交易被取消。在2010年8月24日，5支伦敦证券交易所上市的股票价格发生巨大波动，它们是BT Group PLC, Hays PLC, Next PLC, Northumbrian Water Group PLC 以及United Utilities Group PLC.在这次事件中，似乎并没有发生关于宏观经济或股票的基本面的明显新闻。这次快速下跌触发了伦敦证券交易所的断路机制，该机制有效的阻止了进一步下跌以及蔓延到更广泛的市场。在第六章将会讨论现有的市场控制机制的有效性。
      当然也有很多案例，价格在一天之内波动很大的原因是因为基本面的消息，而不是因为交易系统的问题。1929年的股票市场崩盘被广泛的认为是改正之前的过高估值。1987年的崩盘也被部分归咎于基本面的原因，因为它在全世界范围内引起了震动。很多特定企业的崩盘都是简单的因为关于公司业绩前景的坏消息。
      总而言之，高频交易和自动化交易可能会有助于当前市场阶段性流动性不足的发生。它们可能不是这些市场危机的直接起因，但是它们的交易方式意味着，它们的作为或者不作为可能会暂时性的导致流动性问题被放大。
3.5 未来：下个十年基于计算机的交易将会怎样影响流动性
        高频交易未来所扮演的角色有相当大的不确定性。塔布（TABB）集团在2012年估测高频交易贡献了2011年上半年美国市场53%的交易，相比于2010年61%的份额有所下降。但是2011年8月的极端市场波动见证了高频交易的报复性回归。高频交易公司最大的票据供应商之一的Wedbush公司估计，2011年8月4日到10日之间，高频交易占到了美国市场成交量的75%。当波动率下降到正常幅度时，高频交易是否会继续保持活跃还有待时间检验。
        也有很多预测高频交易的利润率已经达到上限，在接下来的十年会面临进一步的压力。这种衰减可能出于多种原因：美国市场向“微档定价（sub-penny pricing）”迁移的潜在可能性会减少从市场的获利；新的限制多交易场地的订单类型可能获批，这会降低过期价格在不同交易场所之间的获利潜力；新的高频交易进入者会从现有的从业者身上抢走利润；监管和税收可能导致现有商业模式不可用等。随着未来技术的 发展，高频交易的准入门槛可能会降低，这也会加剧竞争。通过降低时间优先级或者更小的报价时间等手段来限制交易速度的微小提升，也会抑制高频交易，因为降低了速度最快的人得到一切这样的刺激性。
       虽然如此，高频交易在下一个10年似乎不可避免的仍然是市场上的优势力量。一个原因是科技的发展使得新闻的获取，聚合以及过滤更为便利。正如在第二章中讨论的这种新闻分析，可以被高频交易商以及投资经理用来进行模型建造。新闻分析技术可以自动对新闻，公司文件等打上电子标签，这项技术使得交易商可以更快的获得更多的信息。将这些信息捆绑到基于电脑的交易之中，为交易商提供了在信息作用于市场价格之前就利用信息的手段。高频交易商会很好的利用这样的新兴技术。
       这种交易会使得信息更快的体现在价格商，就这方面而言，市场将因此收益而变得更有效率。然而这种策略也助长了市场上的“军备竞赛”，因为技术最先进的交易商获得了更多的利润。因此，考虑到随着时间推移，技术扩散到各种人群中，可能在未来所有交易都会跟自动化交易发生关系。
      如果上述现象真的出现，市场可能会经历意想不到的负面效应。其中之一的消息堵塞已经出现过了。消息通道（message traffic）是指通过电脑指令来下单，变更以及取消订单。在任一个交易日，订单数量都会远超过交易量，也就是被变更或取消的订单数远超过交易的订单数。在不稳定的交易日，信息通道流量太大，服务器或者其他电脑部件没有能力处理信息流，可能会导致市场中断。这种市场中断在2010年5月6日的“闪电式崩盘”中广泛出现。在2011年的8月初由于美国市场上Goldman Sachs公司和其他大公司极大的交易量和交易平台的波动又再次出现。当这种现象出现，市场的流动性就会受到影响。
        如果市场参与者的大部分人采用同样的策略可能会引发系统性风险。例如，如果投资组合管理都使用新闻分析作为驱动，那么同一个信息就会引起市场上同时出现卖出（或买入）订单流。对造市商来说这种订单就是“有毒的”，因为造市商就会成为拥有更佳信息的代理人的对手。正如在发生“闪电式崩溃”时所见，当“毒性”淹没了造市商时，他们的策略就是撤回交易，造成流动性不足的后果。因此，新一代的风险管理产品需要涉及到让造市商，交易商和监管者各司其职。程序化交易未来可能要提供更多的技术能力来控制技术以及控制市场。
        最后，既然想要杜绝市场崩盘的发生是不可能的，至少有可能打破经济周期。在未来的危机中，监管机构应该有能力重现发生了什么，什么时候发生的，什么地方发生的以及发生的原因。MiFID的一个重要作用就是松绑欧洲的交易报告协议，因此交易可以通过交易报告系统（Trade Reporting Facilities，TRF）进行报告，而不再是“初级的”市场。这使得事后审计工作比美国市场要困难很多，因为美国市场有某些时刻的买卖汇总记录带。欧洲在收集，整理和分析金融数据方面同美国相比却有些落后。因为在美国市场，美国金融研究办公室（Office of Financial Research ，OFR）通过多德弗兰克法案成立了一个数据中心来收集，整理和分析这些数据。
3.6总结
自动化交易在资本市场上是现实存在的。技术使新的参与者进入市场，新的交易方法崛起，甚至新的市场结构得以演化。它带给市场的大部分是利好的：流动性加强，交易成本下降，市场有效性即使没有更好也肯定没有变得更坏。提高的幅度可能相当小，而且在短期内效果可能被经济合作发展组织（Organisation for Economic Co-operation and Development , OECD），尤其是股票市场指数可怜的表现所掩盖。然而还有很多问题需要解决，比如，阶段性流动性不足，新形式的市场操纵，由于错误的算法或者信息通道的拥堵对市场稳定性的潜在威胁。实践和政策需要进行调整以适应资本市场上交易的新特点。一定要小心谨慎的操作避免犯错抵消了高频交易带来的好处。在未来，技术将会继续影响资本市场，尤其是它可以超高速的将新闻体现到资本价格上。
       下一章节将会讨论市场中技术运用的增加将会怎样影响金融稳定性。
